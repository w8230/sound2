...
function jqGrid_main() {
    $('#mes_grid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'out_qty', index: 'out_qty', sortable: false, width: 100, align: 'right',formatter:'number',fixed:true},
            {name: 'out_loss', index: 'out_loss', sortable: false, width: 100, align: 'right',formatter:'number',fixed:true},
            {name: 'qc_loss', index: 'qc_loss', sortable: false, width: 100, align: 'right',formatter:'number',fixed:true},
